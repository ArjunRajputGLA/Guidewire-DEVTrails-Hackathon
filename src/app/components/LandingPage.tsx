  ...
  return (
    <div className="min-h-screen bg-gray-50/[0.4] font-sans selection:bg-rose-500 selection:text-white scroll-smooth overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gradient-to-tr from-rose-500 to-rose-400 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-rose-200">
                G
              </div>
              <span className="font-bold text-2xl tracking-tight text-gray-900">GigShield</span>
            </div>
            <div className="hidden md:flex space-x-8">
              <a href="#how-it-works" className="text-gray-600 hover:text-rose-500 font-medium transition-colors">How it Works</a>
              <a href="#features" className="text-gray-600 hover:text-rose-500 font-medium transition-colors">Features</a>
              <a href="#stats" className="text-gray-600 hover:text-rose-500 font-medium transition-colors">Impact</a>
            </div>
            <div className="flex items-center gap-4">
              <Link href="/login" className="hidden sm:block text-gray-600 hover:text-gray-900 font-medium transition-colors">Log in</Link>
              <Link href="/signup" className="bg-rose-500 hover:bg-rose-600 text-white px-6 py-2.5 rounded-full font-medium transition-all shadow-lg hover:shadow-xl hover:shadow-rose-200 hover:-translate-y-0.5">
                Join Now
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 text-center lg:text-left z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-100/50 border border-rose-200 text-rose-700 font-medium text-sm mb-6 shadow-sm animate-fade-in-up">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-rose-500 py-1 opacity-75"></span>
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight leading-[1.1] mb-6 animate-fade-in-up delay-100">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 via-red-500 to-orange-500">Smart Insurance</span>
              </h1>
              <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light mt-4 animate-fade-in-up delay-200">
            ...
            <div className="lg:col-span-6 relative mt-16 lg:mt-0 h-[400px] sm:h-[500px] lg:h-[600px] perspective-1000 z-10 w-full max-w-full animate-slide-in-right delay-300">
               ...
               {/* Floating Food 1 */}
               <div className="absolute top-[10%] right-[5%] sm:right-[10%] w-24 h-24 sm:w-32 sm:h-32 z-30 drop-shadow-2xl animate-float-delayed-3 hover:scale-110 transition-transform duration-300 cursor-pointer">
                 <img src={burgerImg.src} alt="Burger" className="w-full h-full object-contain filter drop-shadow-[0_20px_20px_rgba(0,0,0,0.15)]" />
               </div>

               {/* Floating Food 2 */}
               <div className="absolute bottom-[15%] sm:bottom-[20%] right-[-5%] sm:right-[-5%] w-28 h-28 lg:w-40 lg:h-40 z-30 drop-shadow-2xl animate-float-delayed-2 hover:scale-110 transition-transform duration-300 cursor-pointer">
                 <img src={pizzaImg.src} alt="Pizza" className="w-full h-full object-contain filter drop-shadow-[0_20px_20px_rgba(0,0,0,0.15)]" />
               </div>

               {/* Floating Item 3 */}
               <div className="absolute top-[30%] left-[-5%] sm:left-[-10%] w-20 h-20 lg:w-28 lg:h-28 z-30 drop-shadow-2xl animate-float-delayed-1 hover:scale-110 transition-transform duration-300 cursor-pointer">
      ...
      <section id="stats" className="py-12 relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-[-40px]">
        <div className="bg-white/90 rounded-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-slate-100 p-8 sm:p-10 backdrop-blur-2xl transition-all duration-500 hover:shadow-[0_20px_50px_-12px_rgba(244,63,94,0.15)]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-slate-100">
            <div className="flex flex-col items-center justify-center pt-4 md:pt-0 hover:scale-105 transition-transform duration-500 ease-out group">
              <div className="w-14 h-14 bg-rose-50 rounded-2xl flex items-center justify-center mb-4 text-rose-500 group-hover:bg-rose-500 group-hover:text-white transition-colors duration-300">
              ...
              <h3 className="text-4xl font-extrabold text-slate-900 mb-1">3,00,000+</h3>
            ...
            <div className="flex flex-col items-center justify-center pt-8 md:pt-0 hover:scale-105 transition-transform duration-500 ease-out group">
              <div className="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center mb-4 text-orange-500 group-hover:bg-orange-500 group-hover:text-white transition-colors duration-300">
                <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
              </div>
              <h3 className="text-4xl font-extrabold text-slate-900 mb-1">800+</h3>
            ...
            <div className="flex flex-col items-center justify-center pt-8 md:pt-0 hover:scale-105 transition-transform duration-500 ease-out group">
              ...
              <h3 className="text-4xl font-extrabold text-slate-900 mb-1">1M+</h3>
      ...
      <section id="features" className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-rose-500 font-bold tracking-wide uppercase text-sm mb-3">Why Choose Us</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1 */}
            <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-[0_20px_40px_-15px_rgba(244,63,94,0.15)] hover:bg-white hover:-translate-y-2 transition-all duration-500 border border-transparent hover:border-rose-100 group cursor-default">
            ...
            {/* Feature 2 */}
            <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-[0_20px_40px_-15px_rgba(249,115,22,0.15)] hover:bg-white hover:-translate-y-2 transition-all duration-500 border border-transparent hover:border-orange-100 group cursor-default">
              <div className="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 text-3xl group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                🤖
              </div>
            ...
            {/* Feature 3 */}
            <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-[0_20px_40px_-15px_rgba(14,165,233,0.15)] hover:bg-white hover:-translate-y-2 transition-all duration-500 border border-transparent hover:border-sky-100 group cursor-default">
              <div className="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 text-3xl group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                🌦️
              </div>
            ...
            {/* Feature 4 */}
            <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-[0_20px_40px_-15px_rgba(34,197,94,0.15)] hover:bg-white hover:-translate-y-2 transition-all duration-500 border border-transparent hover:border-green-100 group cursor-default">
              <div className="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 text-3xl group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                💰
              </div>
      ...
      <section id="how-it-works" className="py-24 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-rose-500 font-bold tracking-wide uppercase text-sm mb-3">Simple Process</h2>
            <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">How it works</h3>
          </div>

          <div className="relative">
            {/* Connecting line (desktop only) */}
            <div className="hidden md:block absolute top-[40%] left-0 w-full h-1 bg-gradient-to-r from-rose-200 via-orange-200 to-green-200 -z-10 rounded-full opacity-60"></div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
              {/* Step 1 */}
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 bg-white border-[4px] border-rose-100 rounded-full flex items-center justify-center text-rose-500 font-bold text-2xl shadow-lg mb-6 group-hover:scale-110 group-hover:border-rose-300 transition-all duration-500">
                  1
                </div>
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center group">
                <div className="w-20 h-20 bg-white border-[4px] border-orange-100 rounded-full flex items-center justify-center text-orange-500 font-bold text-2xl shadow-lg mb-6 group-hover:scale-110 group-hover:border-orange-300 transition-all duration-500">
                  2
                </div>
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-[2.5rem] p-10 sm:p-16 text-center shadow-2xl relative overflow-hidden">
            {/* Decor */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-rose-500 rounded-full blur-[80px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-500 rounded-full blur-[80px] opacity-20 transform -translate-x-1/2 translate-y-1/2"></div>
            ...
            <Link href="/signup" className="inline-block bg-gradient-to-r from-rose-500 to-rose-400 hover:from-rose-600 hover:to-rose-500 text-white px-10 py-5 rounded-full font-bold text-lg transition-transform hover:scale-105 shadow-xl hover:shadow-rose-500/30 relative z-10">
